...
function Sidebar () {
  return (
    <div className="sidebar">
      ...
      <button type="button" className="sidebar__minimizer">
        <i className="sidebar__minimizer-close fas fa-angle-left" />
        <i className="sidebar__minimizer-open fas fa-angle-right" />
      </button>
    </div>
  );
}
